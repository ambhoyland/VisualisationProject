...
for html_file in html_file_list:
    ...
    draw.text((310, 110), "Day " + str(index) + ' \n' + str(temp_date.strftime('%d-%m-%Y')), (0, 0, 0), font=font)
    img.save(save_name)
...
"""
image_folder = 'home/bigdata/PycharmProjects/VisualisationProject/images'
video_name = 'python_video_test.mp4'
